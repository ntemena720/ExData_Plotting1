...
with(febdate, plot(date_time,Voltage, type = "l", ylab = "Voltage", xlab = "datetime"))
plot(febdate$date_time,febdate$Sub_metering_1, type = "l", ylab = "Energy sub metering", xlab = "")
lines(febdate$date_time,febdate$Sub_metering_2, type = "l", col = "red" )
lines(febdate$date_time,febdate$Sub_metering_3, type = "l", col = "blue" )
legend("topright", c("Sub_metering_1", "Sub_metering_2", "Sub_metering_3"), lty = c(1,1,1),col = c("black", "red", "blue"))
with(febdate, plot(date_time,Global_reactive_power, type = "l", ylab = "Global_reactive_power", xlab = "datetime"))
dev.off()
